var FarmBedroom = Object.create(Location),
    FarmHall = Object.create(Location),
    FarmMaster = Object.create(Location);

// Farmhouse bedroom - starting location
FarmBedroom.name = 'FarmBedroom';
// FarmBedroom.items = [
...
// FarmBedroom.props = [
//     Game.newPropKeyword('window', BedroomWindow)
// ];
FarmBedroom.movement = [
    Game.newMovementKeyword('door', FarmHall)
];
Game.locations.FarmBedroom = FarmBedroom;

// Farmhouse upstairs hallway
FarmHall.name = 'FarmHall';
...
// FarmMaster.props = [
//     Game.newPropKeyword('bed', FarmMasterBed)
// ];
FarmMaster.movement = [
    Game.newMovementKeyword('hall', FarmHall)
];
Game.locations.FarmMaster = FarmMaster;
